...
const reports = [
  {
    ...
    meta: {
      ...
      description:
        "Top downloads from the last 30 days (includes files with at least 1 download).",
    },
  },
  {
    name: "devices",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "90 days of visits, broken down by operating system and date, for all sites.",
    },
  },
  {
    name: "browsers",
  ...
  },
  {
    ...
    meta: {
      names: "Windows",
      description:
        "90 days of visits from Windows users, broken down by operating system version and date, for all sites.",
    },
  },
  {
  ...
  },
  {
    ...
    realtime: false,
    query: {
      dimensions: [{ name: "date" }, { name: "mobileDeviceModel" }],
  ...
  },
  {
    ...
    query: {
      ...
      dimensionFilter: {
        filter: {
          fieldName: "operatingSystemWithVersion",
          stringFilter: { matchType: "CONTAINS", value: "windows" },
        },
      },
      orderBys: [
        {
